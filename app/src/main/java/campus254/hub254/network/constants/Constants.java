package campus254.hub254.network.constants;
...
public interface Constants {
    ...
    public static final String YOUTUBE_API_KEY = "AIzaSyAz8TvzJtYkavsNNRdsQz2T9atmQwZOyc3OTk";

    // Google Pay settings | Settings for In-App Purchasing for Android | See here: https://raccoonsquare.com/help/how_to_add_google_in_app_purchase/

    public static final String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AsMIIBCgKCAQEAn6iTaSxTJwhwjspvU2am8rrikr5lg";

    public static final String WEB_SITE = "https://campus254.hub254.com/";  //web site url address
    ...
    public static final Boolean RECAPTCHA_ENABLE = true; // false = Do not use reCaptcha when creating new account | true = use reCaptcha

    public static final String RECAPTCHA_SITE_KEY = "6LevcdYiAAAAAOmFANONMKzNbQhIWTvb10JPxkF1";
    public static final String RECAPTCHA_SECRET_KEY = "6LevcdYiAAAAAFgAOllQ7HzKRChsV4jWxBJ5pjZr";

    //

    public static final String API_DOMAIN = "https://campus254.hub254.com/";  // url address to which the application sends requests || http://10.0.2.2/ - for test on emulator in localhost [XAMPP]
