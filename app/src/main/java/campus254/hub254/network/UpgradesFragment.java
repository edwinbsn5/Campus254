...
public class UpgradesFragment extends Fragment implements Constants {
    ...
    public void update() {
        ...
        if (App.getInstance().getGhost() == 0) {
            ...
            mGhostModeButton.setText(getString(R.string.action_enable) + " (" + Integer.toString(GHOST_MODE_COST) + ") " + getString(R.string.label_month_time));
        ...
        if (App.getInstance().getVerify() == 0) {
            ...
            mVerifiedBadgeButton.setText(getString(R.string.action_enable) + " (" + Integer.toString(VERIFIED_BADGE_COST) + ") " + getString(R.string.label_life_time));
        ...
        if (App.getInstance().getAdmob() == ADMOB_DISABLED) {
            ...
            mDisableAdsButton.setText(getString(R.string.action_enable) + " (" + Integer.toString(DISABLE_ADS_COST) + ") " + getString(R.string.label_month_time));
