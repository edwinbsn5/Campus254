...
public class RegisterActivity extends ActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (oauth_id == null) {
            ...
            email = i.getStringExtra("oauth_email");
            fullname = i.getStringExtra("oauth_name");
        }
    ...
    private void verifyGoogleReCAPTCHA() {
        ...
        if (!RECAPTCHA_ENABLE) {
            ...
            SafetyNet.getClient(RegisterActivity.this).verifyWithRecaptcha(RECAPTCHA_SITE_KEY)
                    .addOnSuccessListener((Activity) RegisterActivity.this, new OnSuccessListener<SafetyNetApi.RecaptchaTokenResponse>() {
                        @Override
                    ...
                    .addOnFailureListener((Activity) RegisterActivity.this, new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(getApplication(), "reCaptcha is not configured or configured incorrectly.", Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }

    public void register(String recaptchaToken) {
        ...
        CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_ACCOUNT_SIGNUP, null,
                        ...
                        if (App.getInstance().authorize(response)) {
                            ...
                            switch (App.getInstance().getErrorCode()) {
                                ...
                                case ERROR_RECAPTCHA : {
                                    ...
                                    Toast.makeText(RegisterActivity.this, getString(R.string.error_recaptcha), Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("recaptcha_key", RECAPTCHA_SECRET_KEY);
